...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Run"",
                    ""type"": ""Button"",
                    ""id"": ""12d29ac0-7fa9-4c66-a689-32e57969edf4"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""919bc310-f5f8-4c69-899e-02b3f8cc3845"",
                    ""path"": ""<XRController>{LeftHand}/gripPressed"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""047465ea-4af8-4ae1-b16e-d000c81c2027"",
                    ""path"": ""<Keyboard>/l"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHandInteraction_Run = m_XRILeftHandInteraction.FindAction("Run", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRILeftHandInteraction_Run;
    public struct XRILeftHandInteractionActions
    {
        ...
        public InputAction @Run => m_Wrapper.m_XRILeftHandInteraction_Run;
        ...
        public void SetCallbacks(IXRILeftHandInteractionActions instance)
        {
            if (m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface != null)
            {
                ...
                @Run.started -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnRun;
                @Run.performed -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnRun;
                @Run.canceled -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnRun;
            }
